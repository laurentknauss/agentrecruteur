    ...
    <div className="w-full" {...getRootProps()}>
      ...
      >
        ...
        <div className="flex flex-col items-center justify-center">
          <p className="relative z-20 font-sans font-bold text-slate-800 text-base">
            Télécharger un CV
          </p>
          <p className="relative z-20 font-sans font-normal text-slate-800 text-base mt-2">
          ...
          return (
            <div
              ...
              className={`w-10 h-10 flex flex-shrink-0 rounded-[2px] ${index % 2 === 0
                  ? "bg-gray-50"
                  : "bg-gray-50 shadow-[0px_0px_0px_3px_rgba(255,255,255,1)_inset]"
                }`}
            />
          );
        })
